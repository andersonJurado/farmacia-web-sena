...
export default class CompraProducto extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllCompraProductos();
  }
  ...
  public retrieveAllCompraProductos(): void {
  ...
  public prepareRemove(instance: ICompraProducto): void {
  ...
  public removeCompraProducto(): void {
    this.compraProductoService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('farmaciaApp.compraProducto.deleted', { param: this.removeId });
