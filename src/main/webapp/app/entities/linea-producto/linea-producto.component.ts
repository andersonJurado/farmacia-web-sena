...
export default class LineaProducto extends Vue {
  ...
  public mounted(): void {
    this.retrieveAllLineaProductos();
  }
  ...
  public retrieveAllLineaProductos(): void {
  ...
  public prepareRemove(instance: ILineaProducto): void {
  ...
  public removeLineaProducto(): void {
    this.lineaProductoService()
      .delete(this.removeId)
      .then(() => {
        const message = this.$t('farmaciaApp.lineaProducto.deleted', { param: this.removeId });
