            ...
            <div class="pr-xl-4">
              <router-link :to="{ name: 'Home' }" custom v-slot="{ navigate }">
                <center>
                  <img
                    @click="navigate"
                    class="btn btn-info btn-sm details img-logo-footer"
              ...
              <p>
                We are an award-winning creative agency, dedicated to the best result in web design, promotion, business consulting, and
                marketing.
              </p>
              <!-- Rights-->
              <p class="rights">
                <span>©  </span><span class="copyright-year">2018</span><span> </span><span>Waves</span><span>. </span
