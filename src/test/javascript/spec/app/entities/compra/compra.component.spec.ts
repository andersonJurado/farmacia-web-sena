...
import CompraComponent from '@/entities/compra/compra.vue';
import CompraClass from '@/entities/compra/compra.component';
...
describe('Component Tests', () => {
  describe('Compra Management Component', () => {
    ...
    beforeEach(() => {
      ...
      wrapper = shallowMount<CompraClass>(CompraComponent, {
        store,
        i18n,
        localVue,
    ...
    it('should re-initialize the page', async () => {
      ...
      // THEN
      expect(compraServiceStub.retrieve.callCount).toEqual(3);
